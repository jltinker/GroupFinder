...
/* This takes galaxy_environment_random and changes it to be the average number of SDSS galaxies around random points, instead of the other way around.
 */
...
int main(int argc, char **argv)
{
  ...
  for(j=1;j<=nrand;++j)
    {
      if(j%10000==0)fprintf(stderr,"%.2f\n",j*1./nrand);
      cnt = 0;
      for(i=1;i<=ngal;++i)
	{
